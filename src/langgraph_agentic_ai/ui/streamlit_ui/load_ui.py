...
from src.langgraph_agentic_ai.ui.streamlit_ui.ui_config_file import Config
    ...
    def load_streamlit_ui(self):
        ...
        with st.sidebar:
            ...
            if (
                ...
                ) = st.text_input("TAVILY_API_KEY", type="password")

                # Validate API key
                if not self.user_controls["TAVILY_API_KEY"]:
                    st.warning(
                        "Please enter your TAVILY_API_KEY to proceed. Don't have one ? refer to : https://app.tavily.com"
                    )
            ...
            if self.user_controls["selected_usecase"] == "AI News":
                ...
                with st.sidebar:
                    time_frame = st.selectbox(
                        "Select Timeframe", ["Daily", "Weekly", "Monthly"], index=0
                    )
